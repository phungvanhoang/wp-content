...
* This file is a modified of the original plugin found @https://github.com/devinsays/staff-post-type - Special Thanks!
***/
...
class WPEX_Staff_Post_Type {
	...
	function staff_init() {
		...
		$taxonomy_staff_tag_labels = array(
		...
		$taxonomy_staff_tag_args = array(
			'labels'				=> $taxonomy_staff_tag_labels,
			'public'				=> true,
		...
		$taxonomy_staff_tag_args = apply_filters('wpex_taxonomy_staff_tag_args', $taxonomy_staff_tag_args);
		
		register_taxonomy( 'staff_tag', array( 'staff' ), $taxonomy_staff_tag_args );
