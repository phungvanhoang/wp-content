							...
							<ul class="wpex-recent-posts-thumb-grid clearfix">
								...
								foreach( $myposts as $post ) : setup_postdata($post);
									...
									if( has_post_thumbnail() ) { ?>
										<li class="col-<?php echo $wpex_rpw_count ; ?>"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo aq_resize( wp_get_attachment_url( get_post_thumbnail_id() ), '65',  '65',  true ); ?>" alt="<?php the_title(); ?>" /></a></li>
								   <?php
                               		}
									if ( $wpex_rpw_count == 3 ) { $wpex_rpw_count = '0'; }
								endforeach;
								wp_reset_postdata(); ?>
							</ul>
