...
class wpex_flickr extends WP_Widget {
	...
	function wpex_flickr() {
		...
		// register the widget
		$this->WP_Widget('wpex_flickr', WPEX_THEME_BRANDING . ' - '. __( 'Flickr Stream', 'wpex' ), $widget_ops);
...
add_action('widgets_init', create_function('', 'return register_widget("wpex_flickr");'));	
?>