...
define( 'EXPORTS_REPORTS_VERSION', '060' );
...
function exports_reports_report_field( $column, $attributes, $obj ) {
	...
	<style type="text/css">
		...
		.field_data .sortable td div.dragme {
			background: url(<?php echo EXPORTS_REPORTS_URL; ?>assets/icons/move.png) !important;
			width: 16px;
			min-width: 16px;
			height: 16px;
			margin-right: 8px;
						...
						<td>
							<table class="widefat">
								<tr>
									<td>
										<div>Field Name</div>
										<input type="text" name="field_name[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'name' ] ); ?>" class="medium-text" />
									</td>
									<td>
										<div>Data Type</div>
									...
									<td>
										<div>Label (optional)</div>
										<input type="text" name="field_label[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'label' ] ); ?>" class="medium-text" />
									</td>
								</tr>
								<tbody id="field_show_<?php echo $count; ?>" class="field_show">
								<tr>
									<td colspan="3">
										<a href="#advanced" onclick="jQuery('#field_show_<?php echo $count; ?>').hide();jQuery('#field_advanced_<?php echo $count; ?>').show();exports_reports_reset_alt();return false;">+&nbsp;&nbsp;Show Advanced Field Options</a>
									</td>
								</tr>
								</tbody>
								...
								<tr class="field_hide_link">
									<td colspan="3">
										<a href="#advanced" onclick="jQuery('#field_show_<?php echo $count; ?>').show();jQuery('#field_advanced_<?php echo $count; ?>').hide();exports_reports_reset_alt();return false;">-&nbsp;&nbsp;Hide Advanced Field Options</a>
									</td>
								</tr>
								<tr>
									<td>
										<div>Real Field (optional if using Alias)</div>
										<input type="text" name="field_real_name[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'real_name' ] ); ?>" class="medium-text" />
									</td>
									<td>
										<div>Hide from Report</div>
										Yes
										<input type="radio" name="field_hide_report[<?php echo $count; ?>]" value="1" class="medium-text"<?php echo( $field[ 'hide_report' ] == 1 ? ' CHECKED' : '' ); ?> />&nbsp;&nbsp; No<input type="radio" name="field_hide_report[<?php echo $count; ?>]" value="0" class="medium-text"<?php echo( $field[ 'hide_report' ] != 1 ? ' CHECKED' : '' ); ?> />
									</td>
									<td>
										<div>Searchable</div>
										Yes
										<input type="radio" name="field_search[<?php echo $count; ?>]" value="0" class="medium-text"<?php echo( $field[ 'search' ] != 1 ? ' CHECKED' : '' ); ?> />&nbsp;&nbsp; No<input type="radio" name="field_search[<?php echo $count; ?>]" value="1" class="medium-text"<?php echo( $field[ 'search' ] == 1 ? ' CHECKED' : '' ); ?> />
									</td>
								</tr>
								<tr>
									<td>
										<div>Display Function (optional)</div>
										<input type="text" name="field_custom_display[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'custom_display' ] ); ?>" class="medium-text" />
									</td>
									<td>
										<div>Hide from Export</div>
										Yes
										<input type="radio" name="field_hide_export[<?php echo $count; ?>]" value="1" class="medium-text"<?php echo( $field[ 'hide_export' ] == 1 ? ' CHECKED' : '' ); ?> />&nbsp;&nbsp; No<input type="radio" name="field_hide_export[<?php echo $count; ?>]" value="0" class="medium-text"<?php echo( $field[ 'hide_export' ] != 1 ? ' CHECKED' : '' ); ?> />
									</td>
									<td>
										<div>Filterable (optional)</div>
										Yes
										<input type="radio" name="field_filter[<?php echo $count; ?>]" value="1" class="medium-text"<?php echo( $field[ 'filter' ] == 1 ? ' CHECKED' : '' ); ?> />&nbsp;&nbsp; No<input type="radio" name="field_filter[<?php echo $count; ?>]" value="0" class="medium-text"<?php echo( $field[ 'filter' ] != 1 ? ' CHECKED' : '' ); ?> />
									</td>
								</tr>
								<tr>
									<td>
										<div>Filter Label (optional)</div>
										<input type="text" name="field_filter_label[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'filter_label' ] ); ?>" class="medium-text" />
									</td>
									<td>
										<div>Filter using HAVING</div>
										Yes
										<input type="radio" name="field_group_related[<?php echo $count; ?>]" value="1" class="medium-text"<?php echo( $field[ 'group_related' ] == 1 ? ' CHECKED' : '' ); ?> />&nbsp;&nbsp; No<input type="radio" name="field_group_related[<?php echo $count; ?>]" value="0" class="medium-text"<?php echo( $field[ 'group_related' ] != 1 ? ' CHECKED' : '' ); ?> />
									</td>
									<td>
										<div>Default Filter Value (optional)</div>
										<input type="text" name="field_filter_default[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'filter_default' ] ); ?>" class="medium-text" />
									</td>
								</tr>
								<tr>
									<td>
										<div>Ongoing Date Field (optional)</div>
										<input type="text" name="field_filter_ongoing[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'filter_ongoing' ] ); ?>" class="medium-text" />
									</td>
									<td>
										<div>Ongoing Default Filter Value (optional)</div>
										<input type="text" name="field_filter_ongoing_default[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'filter_ongoing_default' ] ); ?>" class="medium-text" />
									</td>
								...
								<tr>
									<td>
										<div>Related Table (if related type)</div>
										<input type="text" name="field_related[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'related' ] ); ?>" class="medium-text" />
									</td>
									<td>
										<div>Related Field (if related type)</div>
										<input type="text" name="field_related_field[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'related_field' ] ); ?>" class="medium-text" />
									</td>
									<td>
										<div>Related WHERE/ORDER BY SQL (if related type)</div>
										<input type="text" name="field_related_sql[<?php echo $count; ?>]" value="<?php echo esc_attr( $field[ 'related_sql' ] ); ?>" class="medium-text" />
									</td>
								</tr>
								</tbody>
							</table>
		...
		<div style="background-color:#E7E7E7;border:1px solid #D7D7D7; padding:5px 15px;margin:15px 15px 0px 5px;">
			...
			<select id="report" onchange="document.location=this.value;">
				...
				foreach ( $selectable_reports as $report_id => $report ) {
					?>
					<option value="<?php echo $admin->var_update( array(
																	   'page' => $_GET[ 'page' ],
																	   'report' => $report_id
																  ), false, false, true ); ?>"<?php echo( $current_report == $report_id ? ' SELECTED' : '' ); ?>><?php echo $report[ 'name' ]; ?></option>
				<?php
				}
				?>
			</select>
...
function exports_reports_log( $args, $obj ) {
	...
	return $wpdb->insert( EXPORTS_REPORTS_TBL . "log", array(
...
function exports_reports_delete_log( $args, $obj ) {
	...
	$filename = $args[ 1 ];
	if ( false !== $args[ 2 ] ) {
		return $wpdb->query( $wpdb->prepare( "DELETE FROM " . EXPORTS_REPORTS_TBL . "log WHERE `report_id`=%d AND `filename`=%s", array(
																																	   $obj[ 0 ]->report_id,
																																	   $filename
																																  ) ) );
	}
