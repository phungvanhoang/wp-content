...
if( !function_exists( 'vcex_woocommerce_carousel_shortcode' ) ) {
	...
	function vcex_woocommerce_carousel_shortcode($atts) {
		...
		if( $vcex_carousel_query->posts ) :
			...
			// Main wrapper div
			$output .= '<div class="vcex-caroufredsel-wrap clr vcex-caroufredsel-woocommerce vcex-caroufredsel-'. $style .' vcex-caroufredsel-loading"'. $unique_id  .'>';
...
vc_map( array(
	"name"					=> __( "WooCommerce Carousel", 'vcex' ),
	...
	"params"				=> array(
		...
		array(
			"type"			=> "dropdown",
			"class"			=> "",
			"heading"		=> __( "Thumbnail Link", 'vcex' ),
		...
		array(
			"type"			=> "dropdown",
			"class"			=> "",
			"heading"		=> __( "Display Details", 'vcex' ),
			"param_name"	=> "details",
			"value"			=> array(
				 __( "True", "wpex")	=> "true",
				 __( "False", "wpex" )	=> "false",
