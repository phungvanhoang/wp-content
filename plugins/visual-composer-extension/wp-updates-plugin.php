...
if( !class_exists('WPUpdatesPluginUpdater_277') ) {
    class WPUpdatesPluginUpdater_277 {
    	...
    	function __construct( $api_url, $plugin_path, $license_key = null ) {
    		...
    		//set_site_transientadd_filter( 'plugins_api_result', array(&$this, 'debug_result'), 10, 3 );
    	}
